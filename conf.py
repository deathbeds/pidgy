...
latex_documents = [
    (master_doc, 'pidgin.tex', 'pidgin Documentation',
     'deathbeds', 'manual'),
]
...
man_pages = [
    (master_doc, 'pidgin', 'pidgin Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pidgin', 'pidgin Documentation',
     author, 'pidgin', 'One line description of project.',
     'Miscellaneous'),
]
